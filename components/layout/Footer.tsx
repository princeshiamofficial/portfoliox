                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-20">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <div className="flex flex-col gap-5 mt-6">
                            ...
                            <a href="tel:+8801919760626" className="flex items-center gap-4 text-gray-400 group hover:text-gray-200 transition-colors">
                                <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center flex-shrink-0 group-hover:bg-primary group-hover:text-white transition-all duration-300 ring-1 ring-white/10 group-hover:ring-primary">
                                    <i className="fas fa-phone-alt"></i>
                                </div>
                                <span className="text-sm">+8801919-760626</span>
                            </a>
                            <a href="mailto:colorhut.official@gmail.com" className="flex items-center gap-4 text-gray-400 group hover:text-gray-200 transition-colors">
                                <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center flex-shrink-0 group-hover:bg-primary group-hover:text-white transition-all duration-300 ring-1 ring-white/10 group-hover:ring-primary">
