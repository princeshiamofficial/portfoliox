...
const VIDEO_REVIEWS = [
    { id: "shorts_1", title: "Order Your Restaurant Menu", thumbnail: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=500&q=80" },
    { id: "shorts_2", title: "Menu Card Design", thumbnail: "https://images.unsplash.com/photo-1550989460-0adf9ea622e2?w=500&q=80" },
    { id: "shorts_3", title: "Digital Menu Showcase", thumbnail: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=500&q=80" },
    { id: "shorts_4", title: "Restaurant Branding", thumbnail: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&q=80" },
    { id: "shorts_5", title: "Customer Success Story", thumbnail: "https://images.unsplash.com/photo-1559339352-11d035aa65de?w=500&q=80" },
];

export const CustomerVideoReviews: React.FC = () => {
    return (
...
const VideoCard = ({ video, index }: { video: any, index: number }) => {
    // In a real app, this would toggle an iframe on click. 
    // For now, we simulate the "Shorts" look with a placeholder UI.
    return (
        <div className="w-[280px] h-[500px] bg-zinc-900 rounded-2xl overflow-hidden relative group cursor-pointer border border-zinc-800 hover:border-orange-500/50 transition-all duration-300 shadow-xl hover:shadow-orange-500/10">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 z-10 text-white">
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <button className="bg-white text-black text-[10px] font-bold px-2 py-1 rounded-full">Subscribe</button>
                </div>
                <p className="text-sm line-clamp-2 font-light text-gray-200">{video.title} - Amazing work done for our client!</p>
            </div>
        </div>
    );
}
