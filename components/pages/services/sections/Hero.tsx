...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-24 pb-6 lg:pt-44 lg:pb-28 bg-gradient-to-b from-orange-50/50 to-white overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-center">
              ...
              <div className="flex flex-row justify-center items-center gap-6 sm:gap-12 lg:pl-4 shrink-0 w-full lg:w-auto">
                ...
                <div className="text-center px-4">
                  ...
                  <p className="font-bengali text-sm md:text-lg font-medium text-gray-600">Coverage Country</p>
                </div>
              </div>
